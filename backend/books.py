...
CORS(app, 
     resources={r"/*": {
         "origins": ["https://read-ranger-hb7cuhjfn-virajcommits-projects.vercel.app"],  # Explicitly allow your Next.js origin
...
def after_request(response):
    response.headers.add('Access-Control-Allow-Origin', 'http://localhost:3000' , 'https://read-ranger-hb7cuhjfn-virajcommits-projects.vercel.app')
